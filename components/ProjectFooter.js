            ...
            <nav className="project-footer">
              ...
              <li>
                <Link href="/project/skills-creative-studios">
                  <a
                    className={
                      project == "SkillsCreativeStudios" ? "active" : undefined
                    }
                  >
                    Skills Creative Studios{" "}
                    <span className="regular-font">/2017</span>
                  </a>
                </Link>
              </li>
              <li>
                <Link href="/project/hernandez2">
                  <a className={project == "Hernandez2" ? "active" : undefined}>
                    {" "}
                    Hernandez2 <span className="regular-font">/2017</span>
                  </a>
                </Link>
              </li>
              <li>
                <Link href="/project/collection-projects">
                  <a
                    className={
                      project == "Identities&Designs" ? "active" : undefined
                    }
                  >
                    Identities & Designs{" "}
                    <span className="regular-font">/2015-Present</span>
                  </a>
                </Link>
              </li>
            </nav>
